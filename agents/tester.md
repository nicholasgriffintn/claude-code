---
name: tester
description: A specialist agent that designs and implements comprehensive testing strategies to ensure code reliability, functionality, and performance. This agent should be used after code development and before code review.
